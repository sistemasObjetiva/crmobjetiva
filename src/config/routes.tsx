...
export const routes: RouteConfig[] = [
  ...
  {
    path: 'productos/proyecto/:proyectoId',
    name: 'Ver Proyecto',
    icon: PeopleIcon,
    rol: ['Gerente','GerenteGeneral', 'Plataforma', 'Usuario'],
    nivel: ['Administrador', 'Usuario'],
    element: React.lazy(() => import('../pages/inventario/InventarioProyectoDetallePage')),
    hideSelector: true,
  },
  {
    path: 'productos/unidad/:proyectoId/:unidadId',
    name: 'Ver Unidad',
    icon: PeopleIcon,
    rol: ['Gerente','GerenteGeneral', 'Plataforma', 'Usuario'],
    nivel: ['Administrador', 'Usuario'],
    element: React.lazy(() => import('../pages/inventario/InventarioUnidadDetallePage')),
    hideSelector: true,
  },
  {
    path: 'productos/propiedad/:propiedadId',
    name: 'Ver Propiedad',
    icon: PeopleIcon,
    rol: ['Gerente','GerenteGeneral', 'Plataforma', 'Usuario'],
    nivel: ['Administrador', 'Usuario'],
    element: React.lazy(() => import('../pages/inventario/InventarioPropiedadDetallePage')),
    hideSelector: true,
  },
  {
    path: 'productos/cotizar/unidad/:proyectoId/:unidadId',
    name: 'Cotizar Unidad',
    icon: PeopleIcon,
    rol: ['Gerente','GerenteGeneral', 'Plataforma', 'Usuario'],
    nivel: ['Administrador', 'Usuario'],
    element: React.lazy(() => import('../pages/inventario/InventarioCotizarUnidadPage')),
    hideSelector: true,
  },
  {
    path: 'productos/cotizar/propiedad/:propiedadId',
    name: 'Cotizar Propiedad',
    icon: PeopleIcon,
    rol: ['Gerente','GerenteGeneral', 'Plataforma', 'Usuario'],
    nivel: ['Administrador', 'Usuario'],
    element: React.lazy(() => import('../pages/inventario/InventarioCotizarPropiedadPage')),
    hideSelector: true,
  },
