...
import { Modal, Box, Tabs, Tab, Typography, IconButton,  Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import VisibilityIcon from '@mui/icons-material/Visibility';
import { Proyecto, Unidad } from '../../config/types'; // Asegúrate de que esta interfaz existe
import CotizadorModal from '../inventario/CotizadorModal'; // Importa el nuevo modal
